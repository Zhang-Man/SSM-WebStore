		...
		<script>
			...
			function add() {
				...
				$.get("myorder.do",function(data){
					...
					alert(jsonobj.listAllgoods);
					var j=0;
					var i=0;
					for(i=0;i<data.listorderid.length;i++)
	            	{
						orderID[i]=data.listorderid[i];
						quantity[i]=1;
	            	}
					
					for(i=0;i<data.listAllgoods.length;i++)
					{
						name[i]=new Array();
						img[i]=new Array();
						price[i]=new Array();
						for(j=0;j<data.listAllgoods[i].listgoods.length;j++)
						{
							name[i][j]=data.listAllgoods[i].listgoods[j].name;
							img[i][j]=data.listAllgoods[i].listgoods[j].mainImage;
							price[i][j]=data.listAllgoods[i].listgoods[j].price;
						}
					}
					
					for(i=0;i<data.listtotalprice.length;i++)
	            	{
						subtotal[i]=data.listtotalprice[i];
	            	}
							
							
							for(i = 0; i < data.listAllgoods.length; i++) {
								$("#stocker").append("<tr><th><h4>OrderID:"+orderID[i][j]+"</h4></th><th></th><th></th><th></th><th></th><th></th></tr>");
								for(j=0;j< data.listAllgoods[i].listgoods.length;j++){
								...
								$("#stocker").append("<tr><td ></td><td ></td><td ></td><td ><h5>TotalPrice:$"+subtotal[i][j]+"</h5></td></tr>");
							}
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-4 is-hidden-sm-down">
                            <ul class="nav-top nav-top-left list-inline t-left">
                                <li><a href="terms_conditions.do"><i class="fa fa-question-circle"></i>Discounts Guide</a>
                                </li>
                                <li><a href="faq.do"><i class="fa fa-support"></i>Customer Assistance</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-sm-12 col-md-8">
                            <ul class="nav-top nav-top-right list-inline t-xs-center t-md-right">
                                ...
                                <li><a href="signinjudge.do"><i class="fa fa-lock"></i>Sign In</a>
                                </li>
                                <li><a href="signup.do"><i class="fa fa-user"></i>Sign Up</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <section class="error-page-area">
                        <div class="container">
                            <div class="error-page-wrapper t-center">
                                ...
                                <a href="index.do" class="btn btn-rounded">Back to home page</a>
                            </div>
                        </div>
                    </section>
                </div>
