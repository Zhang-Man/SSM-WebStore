...
<html>
	...
	<head>
       ...
       function ChangeInfoOnload(){
             ...
             $("#button").click(function(){
          	   var str = {"Tel":$("#Tel").val(),"Sex":$("#Sex").val(),"Birthday":$("#Birthday").val(),"Email":$("#Email").val()}
          	   json = JSON.stringify(str)
               $.get("ChangeInformation.do",{"json":json},function(data){
              	 obj = JSON.parse(data);
              	 if(obj.massage=="ok"){window.location.href="MyCenter-Information.do";}
              	 else{window.location.href="ChangeInfo.do";}
               });
            });
       }
       </script>
	...
	<body onload="ChangeInfoOnload()" style="background: #e9ebee;">
						...
						<div class="review-single pt-30">
							...
							<div class="media">
								<div class="media-middle">
									<button id="button" type="button" style="display: block;margin: 0 auto;" class="btn ">Confirm</button>
								</div>
