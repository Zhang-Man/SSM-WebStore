			...
			<div class="col-lg-12">
				<div class="panel panel-default">
						...
						<table class="table table-hover table-striped">
							...
							<c:forEach items="${list}" var="MfbUser">
							<tr>
								<th>${MfbUser.id}</th>
								<th>${MfbUser.username}</th>
								<th>${MfbUser.tel}</th>
								<th>${MfbUser.mail}</th>
								<th><fmt:formatDate value="${MfbUser.createTime}" pattern="yyyy-MM-dd"/></th>
								<th>${MfbUser.role}</th>
								<th>
									<a class="btn btn-default" href="detail.do?id=${MfbUser.id}">修改</a>
									<p hidden id="deleteId">${MfbUser.id}</p>
