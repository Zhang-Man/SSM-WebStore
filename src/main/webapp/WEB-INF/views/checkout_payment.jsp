     ...
     <script type="text/javascript" src="js/jquery-3.1.0.min.js"></script>
		<script>
			...
			function add(){
				...
				$.get("searchshippingAllWithOneGoods.do",function(data){
					 obj = JSON.parse(data);
			       	 var id=new Array();
			       	 var name=new Array();
			       	 var tel=new Array();
					...
					var postage=0;
					var tatal=price+postage;
					document.getElementById("price").innerHTML="$"+price+"";
					document.getElementById("postage").innerHTML="$"+postage+"";
					document.getElementById("totalprice").innerHTML="$"+tatal+"";
					document.getElementById("goodsid").value=goodsid;
					for (var i=0;i<obj.listshipping.length;i++) {
						$("#address").append("<li><label><input type=\"radio\" name=\"add\" value=\""+id[i]+"\"/>"+name[i]+"\n"+tel[i]+"<p>"+address[i]+"</p></label></li>");
...
<iframe src="head.do " width="100%" height="100%" style="height: 50px;"></iframe>
    ...
    <![endif]-->
		...
		<div id="pageWrapper" class="page-wrapper">
            ...
            <!-- Page Container -->
            <form action="createorderBygoods.do" id="form1">
            <div class="page-sidebar col-xs-12 col-sm-4 col-md-3">

                            <!-- Blog Sidebar -->
                            <aside class="sidebar blog-sidebar" style="margin-top: 60px;margin-left: 380PX;margin-right: 20px;">
                                <div class="row row-tb-10">
                                    <div class="col-xs-50">
                                        <!-- Recent Posts -->
                                        <div class="widget checkout-widget panel p-20" style="height: 370px 100%;width: 300px;">
                                            <div class="widget-body">
                                                <table class="table mb-30">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="color-mid">Price</td>
                                                            <td><span id="price"> </span></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="color-mid">Postage</td>
                                                            <td><span id="postage"></span></td>
                                                        </tr> 
                                                        <input id="goodsid" name="goodsid" style="display:none" value="" />
                                                        <tr class="font-15">
                                                            <td class="color-mid">Total</td>
                                                            <td class="color-green"><span id="totalprice"></span></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <div style="float: left;margin-left: -7px;margin-top: -7px;">
            ...
            <div class="page-container ptb-60" style="margin-right: -750px;">
                <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Game Account</label>
                                                <input type="text" class="form-control" name="account" placeholder="Game Account" required>
                                            </div>
                                        </div>
                                     ...
                                     <a class="btn btn-lg btn-rounded mr-10" onclick="form1()">Continue</a>
                                                                     <a href="#" onclick="javascript:history.back(-1);" class="btn btn-lg btn-warning btn-rounded">Cancel Order</a>
