...
<iframe src="head.do" width="100%" style="height: 45px; margin-bottom: -10px;"></iframe>
		...
		<form action="insertshipping.do" method="post">
							...
							<div class="media">
								...
								<div class="media-body">
									...
									<div class="form-group-lg">
										...
										<input type="text" name="receiverName" id="recipients" class="form-control " placeholder="Recipients">
									</div>
								...
								<div class="media">
									...
									<div class="media-body">
										...
										<div class="form-group-lg">
											...
											<input type="tel" name="receiverPhone" id="tel" class="form-control " placeholder="Tel">
										</div>
									...
									<div class="media">
										...
										<div class="media-body">
											<select name="receiverProvince" id="province_selector" class="bd-filter__select"></select><br />
											<select name="receiverCity" id="city_selector" class="bd-filter__select"></select><br />
											<select name="receiverDistrict" id="district_selector" class="bd-filter__select" ></select>
											...
											<script>
												...
												district_selector.change(function() {
													...
													document.all("Tel").innerHTML = districtCode;
												});
									...
									<div class="media-body">
										...
										<div class="form-group-lg">
											<label class="sr-only">Recipients</label>
											<input name="receiverAddress" type="text" id="address" class="form-control " placeholder="Addess">
										</div>
									...
									<div class="media">
										...
										<div class="media-body">
											...
											<div class="form-group-lg">
												...
												<input type="text" name="receiverZip" id="postcode" class="form-control input-lg" placeholder="Postcode">
											</div>
									...
									<div class="media">
										<div class="media-middle">
											<a><button type="submit" style="display: block;margin: 0 auto;" class="btn ">Confirm</button></a>
										</div>
