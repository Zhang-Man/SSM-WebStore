...
<iframe src="head.do " width="100%" height="100%" style="height: 50px;"></iframe>
					...
					<div class="container">
						<nav class="nav-bar">
							...
							<div id="header-navbar" class="nav-collapse">
								<ul class="nav-menu">
									<li class="active">
										<a href="index.do">Store</a>
									</li>
									<li>
										<a href="coupons_grid.do">Game</a>
										<ul>
											<li>
												<a id="setCategorynameAndGoodssubtitle100">PRICE CONDITION</a>
												<ul>
													<li>
														<a id="setCategorynameAndGoodssubtitle101">Free to Play</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle102">Paying Game</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle103">Discounts</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle104">historically low</a>
													</li>
												</ul>
											</li>
											<li>
												<a id="setCategorynameAndGoodssubtitle200">Browse by Game</a>
												<ul>
													<li>
														<a id="setCategorynameAndGoodssubtitle202">Action</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle204">Adventure</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle203">Casual</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle201">Indie</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle210">Massively Multplayer</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle209">Racing</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle207">RPG</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle205">Simulation</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle208">Sports</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle206">Strategy</a>
													</li>
													
												</ul>
											</li>
											<li>
												<a id="setCategorynameAndGoodssubtitle300">Game Platform</a>
												<ul>
													<li>
														<a id="setCategorynameAndGoodssubtitle301">Origin</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle302">Battle</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle303">Ubisoft</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle304">steam</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle305">Bethesda</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle306">Epic</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle307">Microsoft Store</a>
													</li>
												</ul>
											</li>
											<li>
												<a id="setCategorynameAndGoodssubtitle400">Language</a>
												<ul>
													<li>
														<a id="setCategorynameAndGoodssubtitle401">English</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle402">中文简体</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle404">中文繁體</a>
													</li>
													<li>
														<a id="setCategorynameAndGoodssubtitle405">日本語</a>
													</li>
												</ul>
											</li>
										</ul>
									...
									<li>
										<a href="coupons_grid.do">Software</a>
										<ul>
											<li>
									...
									<li>
										<a href="coupons_grid.do">Hardware</a>
										<ul>
											<li>
												<a href="coupons_grid.do">Hardware</a>
											</li>
            ...
            <div class="page-container ptb-10">
                <div class="container">
                            ...
                            <div class="col-xs-12 col-md-4 col-lg-3">
                                <aside>
                                    <ul class="nav-coupon-category panel">
                                        <li>
												<a href="#" id="setCategorynameAndGoodssubtitle202"><i class="fa fa-hand-rock-o"></i>Action<span>105</span></a>
											</li>
											<li>
												<a href="#" id="setCategorynameAndGoodssubtitle204"><i class="fa fa-area-chart"></i>Adventure<span>42</span></a>
											</li>
											<li>
												<a href="#" id="setCategorynameAndGoodssubtitle203"><i class="fa fa-send"></i>Casual<span>48</span></a>
											</li>
											<li>
												<a href="#" id="setCategorynameAndGoodssubtitle201"><i class="fa fa-tree"></i>Indie<span>33</span></a>
											</li>
											<li>
												<a href="#" id="setCategorynameAndGoodssubtitle210"><i class="fa fa-users"></i>Massively Multplayer<span>50</span></a>
											</li>
											<li>
												<a href="#" id="setCategorynameAndGoodssubtitle209"><i class="fa fa-wheelchair-alt"></i>Racing<span>33</span></a>
											</li>
											<li>
												<a href="#" id="setCategorynameAndGoodssubtitle207"><i class="fa fa-space-shuttle"></i>RPG<span>37</span></a>
											</li>
											<li>
												<a href="#" id="setCategorynameAndGoodssubtitle206"><i class="fa fa-map"></i>Strategy<span>30</span></a>
											</li>
											<li>
												<a href="#" id="setCategorynameAndGoodssubtitle208"><i class="fa fa-soccer-ball-o"></i>Sports<span>48</span></a>
											</li>
											<li class="all-cat">
                            ...
                            <div class="col-xs-12 col-md-8 col-lg-9">
                                <div class="header-deals-slider owl-slider" data-loop="true" data-autoplay="true" data-autoplay-timeout="10000" data-smart-speed="1000" data-nav-speed="false" data-nav="true" data-xxs-items="1" data-xxs-nav="true" data-xs-items="1" data-xs-nav="true" data-sm-items="1" data-sm-nav="true" data-md-items="1" data-md-nav="true" data-lg-items="1" data-lg-nav="true">
                                    ...
                                    <div class="deal-single panel item">
                                        <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="assets/images/deals/deal_13.jpg">
			                    ...
			                    <a href="deal_single.do" class="color-light color-h-lighter">The Crash Bad Instant Folding Twin Bed</a>
                                    ...
                                    <div class="deal-single panel item">
                                        <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="assets/images/deals/deal_14.jpg">
			                    ...
			                    <a href="deal_single.do" class="color-light color-h-lighter">Western Digital USB 3.0 Hard Drives</a>
                                    ...
                                    <div class="deal-single panel item">
                                        <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="assets/images/deals/deal_15.jpg">
                                            <div class="label-discount top-10 right-10">-30%</div>
                                            <ul class="deal-actions top-10 left-10">
                                                <li class="like-deal">
                                                    <span>
                    ...
                    <section class="section latest-deals-area ptb-30">
                        ...
                        <div class="row row-masnory row-tb-20" id="stocker1">
    ...
    function add1(){
    	$.get("underindexsearchAllgoods.do",function(data){
    		var img = new Array();
    		var name = new Array();
    		var price = new Array();
    		...
    		for(var i=0;i<obj.listgoods.length;i++)
    		{
    			...
    			discountprice[i] = price[i] * 0.5;
    		}
    		
    		for(var i = 0; i < obj.listgoods.length; i++) {
    			$("#stocker1").append("<div class='col-sm-6 col-lg-4'><div class='deal-single panel'><img style='height:200px;width:100%' src='"+img[i]+"'><div style='max-height:50px 100%;' class='label-discount left-20 top-15'>-50%</div><ul class='deal-actions top-15 right-20'><li class='like-deal'><span><i class='fa fa-heart'></i></span></li><li class='share-btn'><div class='share-tooltip fade'><a target='_blank' href='#'><i class='fa fa-qq'></i></a><a target='_blank' href='#'><i class='fa fa-wechat'></i></a><a target='_blank' href='#'><i class='fa fa-google-plus'></i></a></div><span><i class='fa fa-share-alt'></i></span></li><li><span><i class='fa fa-camera'></i></span></li></ul><div class='time-left bottom-15 right-20 font-md-14'><span><i class='ico fa fa-clock-o mr-10'></i><span class='t-uppercase' data-countdown='2019/09/01 01:30:00'></span></span></div><div class='deal-store-logo'></div><div class='bg-white pt-20 pl-20 pr-15'><div class='pr-md-10' style=\"max-height: 300px;height: 100%;\"><h3 class='deal-title mb-10'><a href='deal_single.html'>"+name[i]+"</a></h3><ul class='deal-meta list-inline mb-10 color-mid'><li><i class='ico fa fa-map-marker mr-10'></i>United State</li><li><i class='ico fa fa-shopping-basket mr-10'></i>120 Bought</li></ul><textarea style=\"max-height: 100px 100%; border: white; width: 100%;margin-right:5px;overflow: hidden;\" rows=\"6\"cols=\"25\">"+detail[i]+"</textarea></div><div class='deal-price pos-r mb-15' style=\"height: auto; margin-top: -10px;\"><h3 class='price ptb-5 text-right'><span class='price-sale'>$"+price[i]+"</span>$"+discountprice[i]+"</h3></div></div></div></div></div>");
    		}	
    	});
