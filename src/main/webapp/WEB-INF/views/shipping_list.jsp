...
<head>
    ...
    <script type="text/javascript" src="assets/js/jquery-1.12.3.min.js"></script>
 	<script src="assets/js/Goods_list.js"></script>
                            ...
                            <section class="section coupons-area coupons-area-list">
                                ...
                                <header class="page-control panel ptb-15 prl-20 pos-r mb-30">
                                    ...
                                    <ul class="list-control-view list-inline">
                                        <li><a href="coupons_list.do"><i class="fa fa-bars"></i></a>
                                        </li>
                                        <li><a href="coupons_grid.do"><i class="fa fa-th"></i></a>
                                        </li>
                                    </ul>
                                ...
                                <!-- End Page Control -->
                                <div id="socketer" class="row row-masnory row-tb-20">
                                 </div>   
                                        ...
                                        <div class="widget trend-store-widget panel pt-20 prl-20">
                                            ...
                                            <div class="widget-body ptb-30">
                                                <div class="trend-store-item media">
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="mb-5">
                                                         <a href="store_single_01.do">Amazon</a>
                                                         <span class="rating">
                                                         <span class="rating-stars" data-rating="4">
                                                         <i class="fa fa-star-o"></i>
                                                         <i class="fa fa-star-o"></i>
                                                ...
                                                <div class="trend-store-item media">
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="mb-5">
                                                         <a href="store_single_01.do">Ashford</a>
                                                         <span class="rating">
                                                         <span class="rating-stars" data-rating="4">
                                                         <i class="fa fa-star-o"></i>
                                                         <i class="fa fa-star-o"></i>
                                                ...
                                                <div class="trend-store-item media">
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="mb-5">
                                                         <a href="store_single_01.do">DELL</a>
                                                         <span class="rating">
                                                         <span class="rating-stars" data-rating="4">
                                                         <i class="fa fa-star-o"></i>
                                                         <i class="fa fa-star-o"></i>
