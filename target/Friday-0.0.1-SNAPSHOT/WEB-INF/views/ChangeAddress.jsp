		...
		<script>
			...
			function indexOnload() {
				...
				if(sta == 1) {
					...
					var name = "lilei";
					var tel="13245679810";
					var address="asdadadajkda";
					var zip="14545";
					document.all("login").style.display = 'none';
					document.all("user").innerHTML = "<a href='MyCenter-Order.do'>" + name + "</a>";
								...
								<div class="media">
										...
										<div class="media-body">
											...
											<script>
												...
												$.ajax({
													...
													province_selector.do(htm);
													city_selector.do('<option value="">----请选择-----</option>');
													district_selector.do('<option value="">----请选择-----</option>');
												}).fail(function() {
									...
									<div class="media">
										<div class="media-middle">
											<a><button type="button" id="changeshippingbutton" style="display: block;margin: 0 auto;" class="btn ">Confirm</button></a>
										</div>
