...
<html lang="en" dir="ltr" class="no-js">
	...
	<iframe src="head.html" width="100%" style="height: 45px; margin-bottom: -10px;"></iframe>
				...
				<div class="page-container ptb-60">
					<div class="container">
						<section class="sign-area panel p-40">
							<h3 class="sign-title col-left">Forget Password </h3>
							<div class="row row-rl-0">
								<div class="col-sm-8 col-md-center ">
									<form class="p-40" action="#" method="post">
										...
										<div class="form-group">
											...
											<input type="password" id="newPassword2" name="newPassword2" class="form-control input-lg" placeholder="Confirm New Password" onblur="check()">
