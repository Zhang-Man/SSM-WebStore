		...
		<script>
			       $(function MyCenter_AddressOnload(){
			             $.get("searchshippingAll.do",function(data)
						 {
			        		...
			        		for(var j=1;j<=sum;j++)
			        		{
			        			if(j==1){document.getElementById("address1").style.display = "inline";
								...
								document.getElementById("address1_address").innerHTML = "" + address[0] + "";}
			        				if(j==2){document.getElementById("address2").style.display = "inline";
									...
									document.getElementById("address2_address").innerHTML = "" + address[1] + "";}
			        					if(j==3){document.getElementById("address").style.display = "inline";
										...
										document.getElementById("address3_address").innerHTML = "" + address[2] + "";}
			        						if(j==4){document.getElementById("address4").style.display = "inline";
											...
											document.getElementById("address4_address").innerHTML = "" + address[3] + "";}
			        							if(j==5){document.getElementById("address5").style.display = "inline";
						...
						<div id="address1" class="review-single pt-30" style="display: none;">
							<div class="media">
								...
								<div class="media-left">
									<ul>
										<li>
											<a href="ChangeAddress.do"><button id="address1_change1" class="btn-block" style="width: 70px;margin-bottom: 10px;margin-left: 10px;"><i class="fa fa-refresh"></i>修改</button></a>
										</li>
										<li>
											<a><button id="address1_delete1" class="btn-block" style="width: 70px;margin-bottom: 10px;margin-left: 10px;"><i class="fa fa-remove"></i>删除</button></a>
										</li>
									</ul>
								</div>
							</div>
						...
						<div id="address2" class="review-single pt-30" style="display: none;">
							<div class="media">
								...
								<div class="media-left">
									<ul>
										<li>
											<a href="ChangeAddress.do" ><button id="address1_change2" class="btn-block" style="width: 70px;margin-bottom: 10px;margin-left: 10px;"><i class="fa fa-refresh"></i>修改</button></a>
										</li>
										<li>
											<a><button id="address1_delete2" class="btn-block" style="width: 70px;margin-bottom: 10px;margin-left: 10px;"><i class="fa fa-remove"></i>删除</button></a>
										</li>
									</ul>
								</div>
							</div>
						</div>
						<div id="address13" class="review-single pt-30" style="display: none;">
							<div class="media">
								<div class="media-body">
									<div class="review-wrapper clearfix">
										<ul class="list-inline">
								...
								<div class="media-left">
									<ul>
										<li>
											<a href="ChangeAddress.do"><button id="address1_change3" class="btn-block" style="width: 70px;margin-bottom: 10px;margin-left: 10px;"><i class="fa fa-refresh"></i>修改</button></a>
										</li>
										<li>
											<a><button id="address1_delete3" class="btn-block" style="width: 70px;margin-bottom: 10px;margin-left: 10px;"><i class="fa fa-remove"></i>删除</button></a>
										</li>
									</ul>
								</div>
							</div>
						...
						<div id="address4" class="review-single pt-30" style="display: none;">
							<div class="media">
								...
								<div class="media-left">
									<ul>
										<li>
											<a href="ChangeAddress.do"><button id="address1_change4" class="btn-block" style="width: 70px;margin-bottom: 10px;margin-left: 10px;"><i class="fa fa-refresh"></i>修改</button></a>
										</li>
										<li>
											<a><button id="address1_delete4" class="btn-block" style="width: 70px;margin-bottom: 10px;margin-left: 10px;"><i class="fa fa-remove"></i>删除</button></a>
										</li>
									</ul>
								</div>
							</div>
						...
						<div id="address5" class="review-single pt-30" style="display: none;">
							<div class="media">
								...
								<div class="media-left">
									<ul>
										<li>
											<a href="ChangeAddress.do"><button id="address1_change5" class="btn-block" style="width: 70px;margin-bottom: 10px;margin-left: 10px;"><i class="fa fa-refresh"></i>修改</button></a>
										</li>
										<li>
											<a><button id="address1_delete5" class="btn-block" style="width: 70px;margin-bottom: 10px;margin-left: 10px;"><i class="fa fa-remove"></i>删除</button></a>
										</li>
									</ul>
								</div>
