                    ...
                    <div class="row row-rl-10 row-tb-20">
                        <div class="page-content col-xs-12 col-sm-8 col-md-9">
                            ...
                            <section class="section checkout-area panel prl-30 pt-20 pb-40">
                                ...
                                <a href="checkout_billing.do" class="btn btn-lg btn-rounded mr-10">Continue</a>
                                <a href="cart.do" class="btn btn-lg btn-warning btn-rounded">Cancel Order</a>
                            </section>
                            <!-- End Checkout Area -->
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="widget checkout-widget panel p-20">
                                            <div class="widget-body">
                                                ...
                                                <a href="cart.do" class="btn btn-info btn-block btn-sm">Edit Cart</a>
                                            </div>
                                        </div>
                                        <!-- End Recent Posts -->
                                    </div>
