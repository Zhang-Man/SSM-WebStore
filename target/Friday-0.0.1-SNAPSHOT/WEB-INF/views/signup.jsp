                        ...
                        <div id="header-navbar" class="nav-collapse">
                            <ul class="nav-menu">
                                ...
                                <li class="dropdown-mega-menu">
                                    ...
                                    <div class="mega-menu">
                                        <div class="row row-v-10">
                                            <div class="col-md-3">
                                                <ul>
                                                    <li><a href="deals_grid.do">Grid View</a>
                                                    </li>
                                                    <li><a href="deals_grid_sidebar.do">Grid With Sidebar</a>
                                                    </li>
                                                    <li><a href="deals_list.do">List View</a>
                                                    </li>
                                                    <li><a href="deal_single.do">Deal Single</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="col-md-3">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li><a href="stores_01.do">Stores Search</a>
                                        </li>
                                        <li><a href="stores_02.do">Stores Categories</a>
                                        </li>
                                        <li><a href="store_single_01.do">Store Single 1</a>
                                        </li>
                                        <li><a href="store_single_02.do">Store Single 2</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul>
                                        <li><a href="contact_us_01.do">Contact Us 1</a>
                                        </li>
                                        <li><a href="contact_us_02.do">Contact Us 2</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <ul>
                                                <li><a href="blog_classic_right_sidebar.do">Right Sidenar</a>
                                                </li>
                                                <li><a href="blog_classic_left_sidebar.do">Left Sidebar</a>
                                                </li>
                                                <li><a href="blog_classic_fullwidth.do">Full Width</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="#">Grid View</a>
                                            <ul>
                                                <li><a href="blog_grid_3col.do">3 Columns</a>
                                                </li>
                                                <li><a href="blog_grid_2col.do">2 Columns</a>
                                                </li>
                                                <li><a href="blog_grid_right_sidebar.do">Right Sidebar</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="#">List View</a>
                                            <ul>
                                                <li><a href="blog_list_right_sidebar.do">Right Sidenar</a>
                                                </li>
                                                <li><a href="blog_list_left_sidebar.do">Left Sidebar</a>
                                                </li>
                                                <li><a href="blog_list_fullwidth.do">Full Width</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                            ...
                                            <ul>
                                                <li><a href="blog_single_standard.do">Standard Post</a>
                                                </li>
                                                <li><a href="blog_single_gallery.do">Gallery Post</a>
                                                </li>
                                                <li><a href="blog_single_youtube.do">Youtube Video</a>
                                                </li>
                                                <li><a href="blog_single_vimeo.do">Vimeo Video</a>
                                                </li>
                                                <li><a href="blog_single_map.do">Google Map</a>
                                                </li>
                                                <li><a href="blog_single_quote.do">Quote Post</a>
                                                </li>
                                                <li><a href="blog_single_audio.do">Audio Post</a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                                ...
                                <li>
                                    <a href="#">Pages</a>
                                    <ul>
                                        <li><a href="index.do">Home Default</a>
                                        </li>
                                        <li><a href="signinjudge.do">Sign In</a>
                                        </li>
                                        <li><a href="signup.do">Sign Up</a>
                                        </li>
                                        <li><a href="404.do">404 Page</a>
                                        </li>
                                        <li><a href="faq.do">FAQ Page</a>
                                        </li>
                                        <li><a href="cart.do">Cart Page</a>
                                        </li>
                                        <li>
                                            <a href="checkout_method.do">Checkout</a>
                                            <ul>
                                                <li><a href="checkout_method.do">Checkout method</a>
                                                </li>
                                                <li><a href="checkout_billing.do">Billing Information</a>
                                                </li>
                                                <li><a href="checkout_payment.do">Payment Information</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li>
                                        ...
                                        <li><a href="terms_conditions.do">Terms &amp; conditions</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
